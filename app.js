...
const showImages = (images) => {
  ...
  images.forEach(image => {
    ...
    div.innerHTML = ` <img class="img-fluid img-thumbnail" onclick=selectItem(event,"${image.webformatURL}") src="${image.webformatURL}" alt="${image.tags}"> <h5 class="text-center">Title: ${image.tags}</h5>`;
